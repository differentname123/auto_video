...
def match_user(user_detail_upload_info, video_info, all_video_info):
    ...
    for user_name, detail_info in user_detail_upload_info.items():
        if user_name in ['dan', 'nana', 'xiaocai'] and final_score < 5000:
            continue
...
def send_good_plan(manager):
    ...
    :return:
    """
    need_process_users = ['hong', 'dahao', 'junda', 'mama', 'xue', 'danzhu', 'xiaoxiaosu', 'qiuru', 'nana', 'xiaomu', 'shun', 'ping', 'zhong', 'liuzhu', 'qizhu', 'xiaocai', 'xiaoxue']
